...
import { SUPPORT_EMAIL, COMPANY_NAME_LEGAL, WEBSITE_URL, APP_STORE_URL } from '../../config';
...
- **Mac App Store**: [Download MonthBar free]({APP_STORE_URL})
...
A: Download MonthBar free from the [Mac App Store]({APP_STORE_URL}). After installation, MonthBar will appear in your MenuBar.
